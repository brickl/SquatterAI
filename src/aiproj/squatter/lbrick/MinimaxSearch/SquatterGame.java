...
public class SquatterGame implements Piece, Game<Board,Move,Integer> {
    ...
    public static final int STRINGWEIGHT = 50;
    ...
    /**
     * Measures the utility contributed by pieces of the same colour that are neighbouring one another.
     * @param b The board state.
     * @param p The player for whom the  utility is being assessed.
     * @return The utility contributed by pieces that are connected.
     */
    private int checkConnections(Board b, int p) {
        int i, j, utility = 0;
